...
export function EventCard({ event }: EventCardProps) {
  return (
    <div 
      className="bg-white rounded-2xl overflow-hidden hover:-translate-y-1 transition-all"
      style={{ boxShadow: '0 1px 3px rgba(0, 0, 0, 0.04), 0 1px 2px rgba(0, 0, 0, 0.06)' }}
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = '0 10px 15px rgba(0, 0, 0, 0.06), 0 4px 6px rgba(0, 0, 0, 0.05)';
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div className="relative h-[200px] bg-gradient-to-br from-[#00a862] to-[#00d477] overflow-hidden">
        ...
        >
          ...
          <span className="text-[12px] text-[#18181b]" style={{ fontWeight: 600, letterSpacing: '0.01em' }}>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="flex items-center gap-1.5 bg-[#fff9e6] text-[#d97706] border border-[#fef3c7] px-2.5 py-1 rounded-full text-[12px]" style={{ fontWeight: 600 }}>
