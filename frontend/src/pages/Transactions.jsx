...
export default function Transactions() {
    ...
    const [showProcessRedemption, setShowProcessRedemption] = useState(false);
    ...
    const hasPermissions = (role) => {
        ...
        const currentRole = (activeRole || user.role || "").toLowerCase();
    ...
    const fetchTransactions = async (showSpinner = true) => {
        ...
        try {
            ...
            if (
                ...
                advancedFilters.createdBy.trim() !== ""
            ) {
            ...
            if (
                ...
                advancedFilters.promotionId.trim() !== ""
            ) {
            ...
            if (
                ...
                advancedFilters.relatedId.trim() !== ""
            ) {
            ...
            const data = hasPermissions(["manager", "superuser"])
                ...
                : await getUserTransactions(params);
    ...
    const ShowCreateTransactionForm = () => {
        return (
            <div>
                {showProcessRedemption && (
                    <CreateTransaction
                        title={"Process Redemption"}
                        onClose={() => setShowProcessRedemption(false)}
                        type={"processRedemption"}
        ...
        return (
            <AppLayout>
                <CreateTransactionButtons
                    ...
                    setShowCreateRedemption={setShowCreateRedemption}
                    ...
                    setShowProcessRedemption={setShowProcessRedemption}
                />
    ...
    return (
        <AppLayout title="Transactions">
            ...
            {hasPermissions(["regular"]) && (
                <TransactionStats totalCount={totalCount} user={user}/>
            )}
